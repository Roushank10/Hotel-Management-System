...
<script>
	...
	if(date<=today)
	{
	alert("Enter valid check In Or Check Out Date");
    return false;
	}
}
</script>
...
<body>
	...
	<table style="width: 100%;">
		<tr>
			<td id="td1" style="padding: 10px; font-size: 48px;padding-left: 35%;">HOTEL <p style="color: #e6b800; display: inline;">KRISHNA</p> PALACE</td>
	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			...
			<form class="basic_box" action="bookroom1.php" method="post"  onsubmit="return validate()">
				<table>
					<br><br>
					<tr>
					...
					<tr>
						...
						<td style="text-align: left;">
							<input type="date" name="checkin" id="date" required>
						</td>
					</tr>
					<tr>
						<td style="text-align: left;">Enter check-out date:</td>
						<td style="text-align: left;">
							<input type="date" name="checkout" id="date" required>
						</td>
					</tr>
				</table>
				<table>
					...
					<tr>
						<td><input type="checkbox" name="swimming" value="on">swimming</td>
